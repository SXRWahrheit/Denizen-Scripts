wand_ready_check:
    ...
    events:
        ...
        - if <player.item_in_hand.nbt[weapon_type].if_null[null]> == wand && <player.has_flag[attack_cooldown].not>:
        ...
        - else if <player.item_in_hand.nbt[weapon_type].if_null[null]> == wand:
            - flag <player> attack_cooldown:true duration:<player.attack_cooldown_max_duration>
...
wand_spell_handler:
    ...
    events:
        ...
        - if <player.item_in_hand.nbt[weapon_type].if_null[null]> == wand && <player.has_flag[wand_cast]> && <context.spell_name> == <player.item_in_hand.nbt[spell]>:
